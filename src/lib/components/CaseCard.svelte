...
<div
	class="rounded-[var(--radius-card)] border border-secondary bg-white p-8 shadow-card transition-[transform,box-shadow] duration-300 ease-[cubic-bezier(0,0,0.2,1)] hover:-translate-y-0.5"
>
