...
export const workItems: WorkItem[] = [
	...
	// ──── Books ───────────────────────────────────────────────────────────────
	{
		...
		subtitle: 'Piecing Together the Puzzling Network of Parental Pimping, Ritualistic Abuse, and Sex Trafficking',
		year: '2026',
		tag: 'Book',
		isPlaceholder: false,
		...
		summary:
			'For nearly three decades, Cynthia L. Clack, J.D. sat across from mothers who were terrified, children who were telling the truth, and a court system that kept choosing not to listen. Discovering the Club is the book she was compelled to write.',
		body: [
